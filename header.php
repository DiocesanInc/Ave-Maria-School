...
<body <?php body_class(); ?>>
  <?php wp_body_open();?>
    <div class="site" id="page">
        ...
        <?php $trans = get_field('homepage_transparent','options');?>
        <header class="site-header <?php echo ($trans) == 1 ? 'is-transparent home-transparent-background-color' : '';?>" id="masthead">
            <!--data-on-scroll-color="<?php echo TemplateController::getBackgroundColor("header_scroll"); ?>"--> 
